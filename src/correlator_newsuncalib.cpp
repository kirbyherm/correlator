...
//#include "SuN_DSSD_gain_matching_factors.h"
#include "cuts.h"
...
void DSSD::Calibrate( double qvalue ){
  ...
  e_low_raw_thresholds_upper_bounds[0][0]  = 132000;
  e_low_raw_thresholds_upper_bounds[0][1]  = 132000;
  e_low_raw_thresholds_upper_bounds[0][2]  = 132000;
  e_low_raw_thresholds_upper_bounds[0][3]  = -1;
  e_low_raw_thresholds_upper_bounds[0][4]  = 132000;
  e_low_raw_thresholds_upper_bounds[0][5]  = 132000;
  e_low_raw_thresholds_upper_bounds[0][6]  = 132000;
  e_low_raw_thresholds_upper_bounds[0][7]  = 132000;
  e_low_raw_thresholds_upper_bounds[0][8]  = 132000;
  e_low_raw_thresholds_upper_bounds[0][9]  = 132000;
  e_low_raw_thresholds_upper_bounds[0][10] = 132000;
  e_low_raw_thresholds_upper_bounds[0][11] = 132000;
  e_low_raw_thresholds_upper_bounds[0][12] = 132000;
  e_low_raw_thresholds_upper_bounds[0][13] = 132000;
  e_low_raw_thresholds_upper_bounds[0][14] = 132000;
  e_low_raw_thresholds_upper_bounds[0][15] = 132000;
  
  // Low gain, front side, upper bound

  e_low_raw_thresholds_upper_bounds[1][0]  = 132000;
  e_low_raw_thresholds_upper_bounds[1][1]  = 132000;
  e_low_raw_thresholds_upper_bounds[1][2]  = 132000;
  e_low_raw_thresholds_upper_bounds[1][3]  = 132000;
  e_low_raw_thresholds_upper_bounds[1][4]  = 132000;
  e_low_raw_thresholds_upper_bounds[1][5]  = 132000;
  e_low_raw_thresholds_upper_bounds[1][6]  = 132000;
  e_low_raw_thresholds_upper_bounds[1][7]  = 132000;
  e_low_raw_thresholds_upper_bounds[1][8]  = 132000;
  e_low_raw_thresholds_upper_bounds[1][9]  = 132000;
  e_low_raw_thresholds_upper_bounds[1][10] = 132000;
  e_low_raw_thresholds_upper_bounds[1][11] = 132000;
  e_low_raw_thresholds_upper_bounds[1][12] = 132000;
  e_low_raw_thresholds_upper_bounds[1][13] = 132000;
  e_low_raw_thresholds_upper_bounds[1][14] = 132000;
  e_low_raw_thresholds_upper_bounds[1][15] = 132000;
  ...
  e_high_cal_thresholds_upper_bounds[0][0]  = 900+increase;// 1;
  e_high_cal_thresholds_upper_bounds[0][1]  = 900+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[0][2]  = 900+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[0][3]  = 900+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[0][4]  = 850+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[0][5]  = 850+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[0][6]  = 850+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[0][7]  = 850+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[0][8]  = 850+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[0][9]  = 850+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[0][10] = 850+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[0][11] = 880+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[0][12] = 880+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[0][13] = 880+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[0][14] = 900+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[0][15] = 880+increase;// 1; 
                                                        
  // High gain, front side, lower bound                 
                                                        
  e_high_cal_thresholds_upper_bounds[1][0]  = 930+increase;// 1;
  e_high_cal_thresholds_upper_bounds[1][1]  = 930+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[1][2]  = 940+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[1][3]  = 930+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[1][4]  = 900+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[1][5]  = 860+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[1][6]  = 860+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[1][7]  = 850+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[1][8]  = 860+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[1][9]  = 850+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[1][10] = 860+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[1][11] = 860+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[1][12] = 880+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[1][13] = 900+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[1][14] = 920+increase;// 1; 
  e_high_cal_thresholds_upper_bounds[1][15] = 940+increase;// 1; 
...
*/
  ...
  // Bottom segments
  ecSEG[0] = 0.397154728121307 * erSEG[0] - 4.83022332195196;
  ecSEG[1] = 0.397316608819703 * erSEG[1] - 3.2523678601259 ;
  ecSEG[2] = 0.393480582435591 * erSEG[2] - 2.09722049734432;
  ecSEG[3] = 0.397777014914912 * erSEG[3] - 4.08315852517137;
  // Top segments                           
  ecSEG[4] = 0.394558752398934 * erSEG[4] - 12.8675452391742;
  ecSEG[5] = 0.400998158758267 * erSEG[5] - 11.4344019635816;
  ecSEG[6] = 0.395989759950675 * erSEG[6] - 10.5588438687691;
  ecSEG[7] = 0.4020938248448   * erSEG[7] - 15.1021112453205;
...
//    std::cout<<e_PIN2_cal<<" "<<corr_tof<<std::endl;
