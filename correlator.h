...
double DSSD::GetTStripLowAvg() const{
    double avg = (t_strip_low_back + t_strip_low_front)/2.0;
//    std::cout << "B: " << t_strip_low_back << " F: " << t_strip_low_front << " Avg: " << avg << " Maxdiff: " << std::max(abs(avg-t_strip_low_back),abs(avg-t_strip_low_front))<<std::endl;
...
int DSSD::Calibrate(){
  ...
  e_low_slopes[0][2]  = 0.7043856098805408;//1;
  e_low_slopes[0][3]  = 0.7202717512838811;//1;
  e_low_slopes[0][4]  = 0.7350573758232868;//1;
  e_low_slopes[0][5]  = 0.7092320112222021;//1;
  e_low_slopes[0][6]  = 0.7409522880699835;//1;
  e_low_slopes[0][7]  = 0.7094613692745979;//1;
  e_low_slopes[0][8]  = 0.6948855082046944;//1;
  e_low_slopes[0][9]  = 0.7224106311364119;//1;
  e_low_slopes[0][10] = 0.725644425579318 ;//1;
  e_low_slopes[0][11] = 0.7223497952382119;//1;
  e_low_slopes[0][12] = 0.6917499408799856;//1;
  e_low_slopes[0][13] = 0.7271319394392951;//1;
  e_low_slopes[0][14] = 0.7236862423640928;//1;
  e_low_slopes[0][15] = 0.6859640707815926;//1;
  e_low_slopes[0][16] = 0.6510769961277402;//0.74;
  e_low_slopes[0][17] = 0.6541505283545469;//0.74;
  e_low_slopes[0][18] = 0.6676887529251709;//0.74;
  e_low_slopes[0][19] = 0.6596842202506361;//0.74;
  e_low_slopes[0][20] = 0.6585243561817103;//0.74;
  e_low_slopes[0][21] = 0.6482520882700036;//0.74;
  e_low_slopes[0][22] = 0.6543191006156761;//0.74;
  e_low_slopes[0][23] = 0.6602495608161186;//0.74;
  e_low_slopes[0][24] = 0.6614854777854428;//0.74;
  e_low_slopes[0][25] = 0.652750450161575 ;//0.74;
  e_low_slopes[0][26] = 0.6771513041755519;//0.74;
  e_low_slopes[0][27] = 0.6550059592850879;//0.74;
  e_low_slopes[0][28] = 0.6799145580110794;//0.74;
  e_low_slopes[0][29] = 0.6410532786449441;//0.74;
  e_low_slopes[0][30] = 0.650910903139658 ;//0.74;
  e_low_slopes[0][31] = 0.6331860161398006;//0.74;
  e_low_slopes[0][32] = 0.6708640379798846;//0.32;
  e_low_slopes[0][33] = 0.7075308863809825;//0.32;
  e_low_slopes[0][34] = 0.7356352958582737;//0.32;
  e_low_slopes[0][35] = 0.7300257506831282;//0.32;
  e_low_slopes[0][36] = 0.6896919229094447;//0.32;
  e_low_slopes[0][37] = 0.7119680912841833;//0.32;
  e_low_slopes[0][38] = 0.7207104597879724;//0.32;
  e_low_slopes[0][39] = 0.7076926184292449;//0.32;


  // Low gain, front side

  e_low_slopes[1][0]  = 1.0030073845750294;//0.36;
  e_low_slopes[1][1]  = 1.0193650023678937;//0.36;
  e_low_slopes[1][2]  = 0.9901455201927911;//0.36;
  e_low_slopes[1][3]  = 1.0079745593633342;//0.36;
  e_low_slopes[1][4]  = 0.973588760405313 ;//0.36;
  e_low_slopes[1][5]  = 1.0005050962204536;//0.36;
  e_low_slopes[1][6]  = 1.0247834493582493;//0.36;
  e_low_slopes[1][7]  = 0.9922512794673002;//0.36;
  e_low_slopes[1][8]  = 1.0698093595811935;//0.36;
  e_low_slopes[1][9]  = 1.032155214417862 ;//0.36;
  e_low_slopes[1][10] = 0.9782122665883577;//0.36;
  e_low_slopes[1][11] = 1.0172560450766996;//0.36;
  e_low_slopes[1][12] = 1.034203476036732 ;//0.36;
  e_low_slopes[1][13] = 1.061209453391277 ;//0.36;
  e_low_slopes[1][14] = 1.0               ;//0.36;
  e_low_slopes[1][15] = 1.017005982843567 ;//0.36;
  e_low_slopes[1][16] = 0.7035176794486441;//0.60;
  e_low_slopes[1][17] = 0.7136983353233197;//0.60;
  e_low_slopes[1][18] = 0.7151816423133384;//0.60;
  e_low_slopes[1][19] = 0.7127083532680054;//0.60;
  e_low_slopes[1][20] = 0.7259508703100654;//0.60;
  e_low_slopes[1][21] = 0.7258262806049796;//0.60;
  e_low_slopes[1][22] = 0.7065141279977329;//0.60;
  e_low_slopes[1][23] = 0.7084885804650761;//0.60;
  e_low_slopes[1][24] = 0.7338071555583089;//0.60;
  e_low_slopes[1][25] = 0.7175903114871971;//0.60;
  e_low_slopes[1][26] = 0.7211540266657386;//0.60;
  e_low_slopes[1][27] = 0.7083324997946776;//0.60;
  e_low_slopes[1][28] = 0.7097840446630954;//0.60;
  e_low_slopes[1][29] = 0.7082241597823256;//0.60;
  e_low_slopes[1][30] = 0.7191852150066472;//0.60;
  e_low_slopes[1][31] = 0.712083513836915 ;//0.60;
  e_low_slopes[1][32] = 1.0243585775673318;//0.93;
  e_low_slopes[1][33] = 1.0311736418443274;//0.93;
  e_low_slopes[1][34] = 1.0723512472870746;//0.93;
  e_low_slopes[1][35] = 0.9943026137792742;//0.93;
  e_low_slopes[1][36] = 0.9907480738782157;//0.93;
  e_low_slopes[1][37] = 1.0424287312409124;//0.93;
  e_low_slopes[1][38] = 0.9899046464456456;//0.93;
  e_low_slopes[1][39] = 1.0777719485775725;//0.93;
  ...
  e_high_gm[0][1]  = 0.7191445391285389;
  e_high_gm[0][2]  = 0.7043856098805408;
  e_high_gm[0][3]  = 0.7202717512838811;
  e_high_gm[0][4]  = 0.7350573758232868;
  e_high_gm[0][5]  = 0.7092320112222021;
  e_high_gm[0][6]  = 0.7409522880699835;
  e_high_gm[0][7]  = 0.7094613692745979;
  e_high_gm[0][8]  = 0.6948855082046944;
  e_high_gm[0][9]  = 0.7224106311364119;
  e_high_gm[0][10] = 0.725644425579318 ;
  e_high_gm[0][11] = 0.7223497952382119;
  e_high_gm[0][12] = 0.6917499408799856;
  e_high_gm[0][13] = 0.7271319394392951;
  e_high_gm[0][14] = 0.7236862423640928;
  e_high_gm[0][15] = 0.6859640707815926;
  e_high_gm[0][16] = 0.6510769961277402;
  e_high_gm[0][17] = 0.6541505283545469;
  e_high_gm[0][18] = 0.6676887529251709;
  e_high_gm[0][19] = 0.6596842202506361;
  e_high_gm[0][20] = 0.6585243561817103;
  e_high_gm[0][21] = 0.6482520882700036;
  e_high_gm[0][22] = 0.6543191006156761;
  e_high_gm[0][23] = 0.6602495608161186;
  e_high_gm[0][24] = 0.6614854777854428;
  e_high_gm[0][25] = 0.652750450161575 ;
  e_high_gm[0][26] = 0.6771513041755519;
  e_high_gm[0][27] = 0.6550059592850879;
  e_high_gm[0][28] = 0.6799145580110794;
  e_high_gm[0][29] = 0.6410532786449441;
  e_high_gm[0][30] = 0.650910903139658 ;
  e_high_gm[0][31] = 0.6331860161398006;
  e_high_gm[0][32] = 0.6708640379798846;
  e_high_gm[0][33] = 0.7075308863809825;
  e_high_gm[0][34] = 0.7356352958582737;
  e_high_gm[0][35] = 0.7300257506831282;
  e_high_gm[0][36] = 0.6896919229094447;
  e_high_gm[0][37] = 0.7119680912841833;
  e_high_gm[0][38] = 0.7207104597879724;
  e_high_gm[0][39] = 0.7076926184292449;

  e_high_gm[1][0]  = 1.0030073845750294;
  e_high_gm[1][1]  = 1.0193650023678937; 
  e_high_gm[1][2]  = 0.9901455201927911;
  e_high_gm[1][3]  = 1.0079745593633342;
  e_high_gm[1][4]  = 0.973588760405313 ;
  e_high_gm[1][5]  = 1.0005050962204536;
  e_high_gm[1][6]  = 1.0247834493582493;
  e_high_gm[1][7]  = 0.9922512794673002;
  e_high_gm[1][8]  = 1.0698093595811935;
  e_high_gm[1][9]  = 1.032155214417862 ;
  e_high_gm[1][10] = 0.9782122665883577;
  e_high_gm[1][11] = 1.0172560450766996;
  e_high_gm[1][12] = 1.034203476036732 ;
  e_high_gm[1][13] = 1.061209453391277 ;
  e_high_gm[1][14] = 1.0               ;
  e_high_gm[1][15] = 1.017005982843567 ;
  e_high_gm[1][16] = 0.7035176794486441;
  e_high_gm[1][17] = 0.7136983353233197;
  e_high_gm[1][18] = 0.7151816423133384;
  e_high_gm[1][19] = 0.7127083532680054;
  e_high_gm[1][20] = 0.7259508703100654;
  e_high_gm[1][21] = 0.7258262806049796;
  e_high_gm[1][22] = 0.7065141279977329;
  e_high_gm[1][23] = 0.7084885804650761;
  e_high_gm[1][24] = 0.7338071555583089;
  e_high_gm[1][25] = 0.7175903114871971;
  e_high_gm[1][26] = 0.7211540266657386;
  e_high_gm[1][27] = 0.7083324997946776;
  e_high_gm[1][28] = 0.7097840446630954;
  e_high_gm[1][29] = 0.7082241597823256;
  e_high_gm[1][30] = 0.7191852150066472;
  e_high_gm[1][31] = 0.712083513836915 ;
  e_high_gm[1][32] = 1.0243585775673318;
  e_high_gm[1][33] = 1.0311736418443274;
  e_high_gm[1][34] = 1.0723512472870746;
  e_high_gm[1][35] = 0.9943026137792742;
  e_high_gm[1][36] = 0.9907480738782157;
  e_high_gm[1][37] = 1.0424287312409124;
  ...
  e_low_raw_thresholds_lower_bounds[0][2]  = 1000000;
  e_low_raw_thresholds_lower_bounds[0][3]  = 1000000;
  e_low_raw_thresholds_lower_bounds[0][4]  = 1000000;
  ...
  e_low_raw_thresholds_lower_bounds[0][39] = 1000000;

  // Low gain, front side, lower bound

  e_low_raw_thresholds_lower_bounds[1][0]  = 1000000;
  e_low_raw_thresholds_lower_bounds[1][1]  = 1000000;
  ...
  e_low_raw_thresholds_upper_bounds[0][39] = -1;
  ...
  e_high_raw_thresholds_lower_bounds[0][16] = 1;
  e_high_raw_thresholds_lower_bounds[0][17] = 1;
  e_high_raw_thresholds_lower_bounds[0][18] = 1;
  e_high_raw_thresholds_lower_bounds[0][19] = 1;
  e_high_raw_thresholds_lower_bounds[0][20] = 1;
  e_high_raw_thresholds_lower_bounds[0][21] = 1;
  e_high_raw_thresholds_lower_bounds[0][22] = 1;
  e_high_raw_thresholds_lower_bounds[0][23] = 1;
  e_high_raw_thresholds_lower_bounds[0][24] = 1;
  e_high_raw_thresholds_lower_bounds[0][25] = 1;
  e_high_raw_thresholds_lower_bounds[0][26] = 1;
  e_high_raw_thresholds_lower_bounds[0][27] = 1;
  e_high_raw_thresholds_lower_bounds[0][28] = 1;
  e_high_raw_thresholds_lower_bounds[0][29] = 1;
  e_high_raw_thresholds_lower_bounds[0][30] = 1;
  e_high_raw_thresholds_lower_bounds[0][31] = 1;
  e_high_raw_thresholds_lower_bounds[0][32] = 1;
  e_high_raw_thresholds_lower_bounds[0][33] = 1;
  e_high_raw_thresholds_lower_bounds[0][34] = 1;
  e_high_raw_thresholds_lower_bounds[0][35] = 1;
  e_high_raw_thresholds_lower_bounds[0][36] = 1;
  e_high_raw_thresholds_lower_bounds[0][37] = 1;
  e_high_raw_thresholds_lower_bounds[0][38] = 1;
  e_high_raw_thresholds_lower_bounds[0][39] = 1;
  ...
  e_high_raw_thresholds_lower_bounds[1][16] = 1;
  e_high_raw_thresholds_lower_bounds[1][17] = 1;
  e_high_raw_thresholds_lower_bounds[1][18] = 1;
  e_high_raw_thresholds_lower_bounds[1][19] = 1;
  e_high_raw_thresholds_lower_bounds[1][20] = 1;
  e_high_raw_thresholds_lower_bounds[1][21] = 1;
  e_high_raw_thresholds_lower_bounds[1][22] = 1;
  e_high_raw_thresholds_lower_bounds[1][23] = 1;
  e_high_raw_thresholds_lower_bounds[1][24] = 1;
  e_high_raw_thresholds_lower_bounds[1][25] = 1;
  e_high_raw_thresholds_lower_bounds[1][26] = 1;
  e_high_raw_thresholds_lower_bounds[1][27] = 1;
  e_high_raw_thresholds_lower_bounds[1][28] = 1;
  e_high_raw_thresholds_lower_bounds[1][29] = 1;
  e_high_raw_thresholds_lower_bounds[1][30] = 1;
  e_high_raw_thresholds_lower_bounds[1][31] = 1;
  e_high_raw_thresholds_lower_bounds[1][32] = 1;
  e_high_raw_thresholds_lower_bounds[1][33] = 1;
  e_high_raw_thresholds_lower_bounds[1][34] = 1;
  e_high_raw_thresholds_lower_bounds[1][35] = 1;
  e_high_raw_thresholds_lower_bounds[1][36] = 1;
  e_high_raw_thresholds_lower_bounds[1][37] = 1;
  e_high_raw_thresholds_lower_bounds[1][38] = 1;
  e_high_raw_thresholds_lower_bounds[1][39] = 1;
  ...
  e_high_cal_thresholds_upper_bounds[0][2]  = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][3]  = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][4]  = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][5]  = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][6]  = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][7]  = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][8]  = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][9]  = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][10] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][11] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][12] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][13] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][14] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][15] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][16] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][17] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][18] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][19] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][20] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][21] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][22] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][23] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][24] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][25] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][26] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][27] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][28] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][29] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][30] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][31] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][32] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][33] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][34] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][35] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][36] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][37] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][38] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[0][39] = 2000+increase;

  // High gain, front side, upper bound

  e_high_cal_thresholds_upper_bounds[1][0]  = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][1]  = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][2]  = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][3]  = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][4]  = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][5]  = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][6]  = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][7]  = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][8]  = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][9]  = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][10] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][11] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][12] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][13] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][14] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][15] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][16] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][17] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][18] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][19] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][20] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][21] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][22] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][23] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][24] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][25] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][26] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][27] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][28] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][29] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][30] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][31] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][32] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][33] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][34] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][35] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][36] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][37] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][38] = 2000+increase;
  e_high_cal_thresholds_upper_bounds[1][39] = 2000+increase;
...
//        std::cout << t_low_raw[i][j] << ", " << t_low_cal[i][j] << ", " << t_strip_low_back << std::endl;
	      } // end if elowcal >=estriplowback
//        std::cout << e_low_cal[i][j] << ", " << e_strip_low_back << ", test: " << bool(e_low_cal[i][j] >= e_strip_low_back) << std::endl;
	} // end if i ==0
...
//        if (overflows.size() <= 1){ 
        ...
        if (i == 0){
          ...
          e_strip_low_back = int(e_low_cal[i][mid]);
//          e_strip_low_back = int(round(totenergy/mult));
        } // end if i==0
        if (i == 1){
          c_strip_low_front = mid;
          t_strip_low_front = t_low_cal[i][mid];
          e_strip_low_front = int(e_low_cal[i][mid]);
//          e_strip_low_front = int(round(totenergy/mult));
        } // end if i==1
//        std::cout << e_strip_low_back << ", " << e_strip_low_front << std::endl;
    ...
    double e_high_cal_temp = e_high_slopes[i][j] * e_high_raw[i][j] * e_high_gm[i][j] + e_high_intercepts[i][j]; 
...
//        continue;
	...
	if (i==0){ // High gain, back side
	  ...
	  if (e_high_cal[i][j] > e_strip_high_back && e_high_cal[i][j] > e_high_cal_thresholds_lower_bounds[i][j] && e_high_cal[i][j] < e_high_cal_thresholds_upper_bounds[i][j]
            ){
	    c_strip_high_back = j;
	...
	if (i==1){ // High gain, front side
	  ...
	  if (e_high_cal[i][j] > e_strip_high_front && e_high_cal[i][j] > e_high_cal_thresholds_lower_bounds[i][j] && e_high_cal[i][j] < e_high_cal_thresholds_upper_bounds[i][j]
            ){
...
//*/
    ...
    total_overflows += separate_overflows; //overflows.size();
    if (m_low_cal[i] > 0 || overflows.size() > 0 || num_overflow > 0){
//    std::cout << m_low_cal[i] << ", " << overflows.size() << ", " << num_overflow << std::endl;
    }
  } // end for i

//        std::cout <<  e_strip_low_back << std::endl;
//        std::cout <<  e_strip_low_front << std::endl;
...
public:
  ...
  SSSD (int input_e_SSSD_raw[2][16], // double, even though energy from ddas2root is int
	double input_t_SSSD_raw[2][16])
...

  {
    ...
    std::memcpy(e_SSSD_raw, input_e_SSSD_raw, 2*16*sizeof(int));
    std::memcpy(t_SSSD_raw, input_t_SSSD_raw, 2*16*sizeof(double));
    e_SSSD_max = 1;
    t_SSSD_max = 0;
...
private:
  ...
  int e_SSSD_raw[2][16];
  double e_SSSD_cal[2][16];
  double t_SSSD_raw[2][16];
  double t_SSSD_cal[2][16];
  double e_SSSD_max;
  double t_SSSD_max;
};

double SSSD::GetRawEnergy(int strip) const{
  return e_SSSD_raw[1][strip];
}

double SSSD::GetCalEnergy(int strip) const{
  return e_SSSD_cal[1][strip];
}

double SSSD::GetRawTime(int strip) const{
  return t_SSSD_raw[1][strip];
}

double SSSD::GetCalTime(int strip) const{
  return t_SSSD_cal[1][strip];
}
...
void SSSD::Calibrate(){
   ...
   e_SSSD_raw_thresholds_lower_bounds[0]  = 800 -reduce;
   e_SSSD_raw_thresholds_lower_bounds[1]  = 1600-reduce;
   e_SSSD_raw_thresholds_lower_bounds[2]  = 1200-reduce;
   e_SSSD_raw_thresholds_lower_bounds[3]  = 900 -reduce;
   e_SSSD_raw_thresholds_lower_bounds[4]  = 800 -reduce;
   e_SSSD_raw_thresholds_lower_bounds[5]  = 750 -reduce;
   e_SSSD_raw_thresholds_lower_bounds[6]  = 750 -reduce;
   e_SSSD_raw_thresholds_lower_bounds[7]  = 950 -reduce;
   e_SSSD_raw_thresholds_lower_bounds[8]  = 750 -reduce;
   e_SSSD_raw_thresholds_lower_bounds[9]  = 750 -reduce;
   e_SSSD_raw_thresholds_lower_bounds[10] = 750 -reduce;
   e_SSSD_raw_thresholds_lower_bounds[11] = 750 -reduce;
   e_SSSD_raw_thresholds_lower_bounds[12] = 775 -reduce;
   e_SSSD_raw_thresholds_lower_bounds[13] = 800 -reduce;
   e_SSSD_raw_thresholds_lower_bounds[14] = 1025-reduce;
   e_SSSD_raw_thresholds_lower_bounds[15] = 1250-reduce;
   
   e_SSSD_raw_thresholds_upper_bounds[0]  = -1;
   e_SSSD_raw_thresholds_upper_bounds[1]  = 33000;
   e_SSSD_raw_thresholds_upper_bounds[2]  = 33000;
   e_SSSD_raw_thresholds_upper_bounds[3]  = 33000;
   e_SSSD_raw_thresholds_upper_bounds[4]  = 33000;
   e_SSSD_raw_thresholds_upper_bounds[5]  = 33000;
   e_SSSD_raw_thresholds_upper_bounds[6]  = 33000;
   e_SSSD_raw_thresholds_upper_bounds[7]  = 33000;
   e_SSSD_raw_thresholds_upper_bounds[8]  = 33000;
   e_SSSD_raw_thresholds_upper_bounds[9]  = 33000;
   e_SSSD_raw_thresholds_upper_bounds[10] = 33000;
   e_SSSD_raw_thresholds_upper_bounds[11] = 33000;
   e_SSSD_raw_thresholds_upper_bounds[12] = 33000;
   e_SSSD_raw_thresholds_upper_bounds[13] = 33000;
   e_SSSD_raw_thresholds_upper_bounds[14] = 33000;
   e_SSSD_raw_thresholds_upper_bounds[15] = 33000;
...
//     std::cout<<e_SSSD_max<<" "<<e_SSSD_cal[i]<<" "<<e_SSSD_raw[i]<<std::endl;
	 //Find max energy
	    ...
	    e_SSSD_max = e_SSSD_cal[1][i];
//        std::cout<<e_SSSD_max<<std::endl;
	 }
      }
   }
}
...
//   e_scint_hithres = 32000;
   e_scint_lowthres = scint_thresh;
   e_scint_hithres = 33000;
...
public:
  ...
  //Methods
  bool IsPunchthrough(bool isDecay);

private:

};

bool Punchthrough::IsPunchthrough(bool isDecay){
...
class Implantation {
	...
	public:
...

	  {
	    ...
	    time_between_back_to_back_implantations = -1;
	    is_implanted = false;
	  ...
	  bool IsValidImplantation(bool imp2);
	  bool IsImplanted();
	  // Set Methods
	...
	bool Implantation::IsValidImplantation(bool imp2){
...
//              std::cout<<"pin1: "<<pin_sub_event.GetPIN1RawEnergy()<<" pin2: "<<pin_sub_event.GetPIN2RawEnergy()<<" DSSDback: "<<dssd_sub_event.GetCStripLowBack()<<" DSSDfront: "<<dssd_sub_event.GetCStripLowFront()<<std::endl;
	      return false;
	    }
      } else {
	    if (pin_sub_event.GetPIN1RawEnergy() > 0 &&
	        ...
	        dssd_sub_event.GetEStripLowBack() > 0 &&
	        dssd_sub_event.GetEStripLowFront() > 0  
	        && dssd_sub_event.GetLowCalMultiplicity(0) < 2 
	        && dssd_sub_event.GetLowCalMultiplicity(1) < 2
	        && sssd_sub_event.GetMaxEnergy() <32000
          ){
	      return true;
	    }
...
public:
  ...
  // Methods
  // Get Methods
  bool IsValidDecay(bool dec2);
private:

};

bool Decay::IsValidDecay(bool dec2){

  // Conditions for a valid decay
  // Note whether the thresholds apply to raw or calibrated values
  if (dec2) {
    if (pin_sub_event.GetPIN1RawEnergy() < 1 &&
        pin_sub_event.GetPIN2RawEnergy() < 1 &&
        dssd_sub_event.GetEStripHighBack() > 0 &&
        dssd_sub_event.GetEStripHighFront() > 0 && 
        dssd_sub_event.GetEStripLowBack() < 1 &&
        dssd_sub_event.GetEStripLowFront() < 1
        && scint_sub_event.GetScintCalEnergy() == -1 
       ) {
  //      dssd_sub_event.GetEStripLowBack() == 0 &&
  //      dssd_sub_event.GetEStripLowFront() == 0) {
  /*  if (dssd_sub_event.GetEStripHighBack() > 0 &&
        dssd_sub_event.GetEStripHighFront() > 0) {*/
  //    std::cout<<dssd_sub_event.GetEStripHighBack() << ", " << dssd_sub_event.GetEStripHighFront()<< std::endl;
      return true;
    }
    else {
      return false;
    ...
    if (pin_sub_event.GetPIN1RawEnergy() == 0 &&
        ...
        dssd_sub_event.GetEStripLowBack() == 0 &&
        dssd_sub_event.GetEStripLowFront() == 0
        &&  dssd_sub_event.GetHighCalMultiplicity(0) < 2
        && dssd_sub_event.GetHighCalMultiplicity(1) < 2
        && scint_sub_event.GetScintCalEnergy() == -1 
       ) {
      return true;
    }
